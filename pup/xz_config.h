...
#define kmalloc(size, flags) xz_malloc_stub(size)
#define kfree(ptr) xz_free_stub(ptr)
#define vmalloc(size) xz_malloc_stub(size)
#define vfree(ptr) xz_free_stub(ptr)
